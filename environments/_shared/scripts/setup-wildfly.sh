...
setupEnvVars
#deployWars
sudo cp /home/asw/_shared/deployments/hello.war /usr/local/wildfly/standalone/deployments/
#echo "is there a file?:"
#cat /usr/local/wildfly/standalone/deployments/hello.war
